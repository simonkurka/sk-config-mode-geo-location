...
function M.section(form)
  ...
  o = s:option(cbi.Flag, "_showlocation", i18n.translate("Show node on the map"))
  o.default = uci:get_first("gluon-node-info", "location", "share_location", o.enabled)
  o.rmempty = false

  o = s:option(cbi.Flag, "_autolocation", i18n.translate("Make the router locate itself"))
  o.default = uci:get_first("autolocate", "location", "auto_location", o.enabled)
  o.rmempty = false

  o = s:option(cbi.Value, "_latitude", i18n.translate("Latitude"))
  o.default = uci:get_first("gluon-node-info", "location", "latitude")
  o:depends("_autolocation", "0")
  o.rmempty = false
  o.datatype = "float"
...
function M.handle(data)
  ...
  uci:set("gluon-node-info", sname, "share_location", data._showlocation)
